				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
							...
							<ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
								...
								<li>
									<div class="notif-center">
										...
										<a href="#">
											<div class="notif-img"> 
												<img src="{{ asset('theme/backend') }}/assets/img/profile2.jpg" alt="Img Profile">
											</div>
											<div class="notif-content">
												<span class="block">
						...
						<li class="nav-item dropdown">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="{{ asset('theme/backend') }}/assets/img/profile.jpg" alt="user-img" width="36" class="img-circle"><span >Hizrian</span></span> </a>
							<ul class="dropdown-menu dropdown-user">
								<li>
									<div class="user-box">
										<div class="u-img"><img src="{{ asset('theme/backend') }}/assets/img/profile.jpg" alt="user"></div>
										<div class="u-text">
											<h4>Hizrian</h4>
